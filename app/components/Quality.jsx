  ...
  return (
    <section className="text-white py-10 px-4 sm:px-6">
      <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-4 font-cormorant_garamond text-[#111]">
        WHY <span className="text-[#133289] ">CHOOSE US</span>
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {[
          ...
          <div
            key={index}
            className="group border border-[#133289] p-4 rounded shadow-sm bg-[#0F0F16] transition-all duration-300 hover:bg-[#133289] hover:text-white"
          >
            <p className="font-bold text-[#cd99cd] font-bebas_Neue text-3xl sm:text-4xl lg:text-5xl mb-2 transition-all duration-300 group-hover:text-white">
              {item.num}
            </p>
