...
const services = [
  {
    ...
    icon: <FaHome className="text-[#6e49a3] text-2xl sm:text-3xl" />,
  ...
  },
  {
    ...
    icon: <FaUserTie className="text-[#6e49a3] text-2xl sm:text-3xl" />,
  ...
  },
  {
    ...
    icon: <FaBuilding className="text-[#6e49a3] text-2xl sm:text-3xl" />,
  ...
  },
  {
    ...
    icon: <FaHandshake className="text-[#6e49a3] text-2xl sm:text-3xl" />,
  ...
  },
  {
    ...
    icon: <FaFileContract className="text-[#6e49a3] text-2xl sm:text-3xl" />,
    ...
    <section id="services" className="py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-8 font-cormorant_garamond text-[#111]">
          Our <span className="tg">Services</span>
        </h2>
            ...
            <Link href={service.href} key={index} className="block group">
              <div className="bg-white border border-[rgba(0,0,0,0.1)] shadow-xl  rounded-2xl p-6 flex items-start justify-between h-full transition-all duration-300 hover:shadow-[0_10px_25px_rgba(0,0,0,0.15)] hover:-translate-y-1">
                <div className="max-w-[80%]">
                  <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800 group-hover:text-[#6e49a3] font-bebas_Neue">
                    {service.title}
                  </h3>
