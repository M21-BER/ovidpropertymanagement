export default function Loading() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#fff] bg-opacity-80 backdrop-blur-sm">
      <div className="flex flex-col items-center gap-4">
        ...
        {/* Text */}
        <p className="text-black font-medium text-lg tracking-wide uppercase">
          Loading...
        </p>
      </div>
    </div>
